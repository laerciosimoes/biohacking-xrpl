...
export const metadata: Metadata = {
  title: 'Biohacking Healthcare',
  description: 'Biohacking Healthcare Frontend Example',
  metadataBase: new URL('https://healthcare.biohacking.ai'),
  openGraph: {
    title: 'Biohacking Healthcare',
    description: 'Biohacking Healthcare Frontend Example',
    url: 'https://healthcare.biohacking.ai',
    siteName: 'Biohacking Healthcare',
    images: '/biohacking.png',
  },
  alternates: {
    canonical: '/',
  },
  applicationName: 'Biohacking Healthcare',
  referrer: 'origin',
  ...
  twitter: {
    ...
    title: 'Biohacking Healthcare Frontend Example',
    description: 'Biohacking Healthcare Frontend Example',
    images: ['/biohacking.png'],
  }
}
