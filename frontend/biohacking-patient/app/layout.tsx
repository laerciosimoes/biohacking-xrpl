...
export const metadata: Metadata = {
  title: 'Biohacking Patient',
  description: 'Biohacking Patient Frontend Example',
  metadataBase: new URL('https://patient.biohacking.ai'),
  openGraph: {
    title: 'Biohacking Patient',
    description: 'Biohacking Patient Frontend Example',
    url: 'https://patient.biohacking.ai',
    siteName: 'Biohacking Patient',
    images: '/biohacking.png',
  },
  alternates: {
    canonical: '/',
  },
  applicationName: 'Biohacking Patient',
  referrer: 'origin',
  ...
  twitter: {
    ...
    title: 'Biohacking Patient Frontend Example',
    description: 'Biohacking Patient Frontend Example',
    images: ['/biohacking.png'],
  }
}
